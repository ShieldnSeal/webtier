    ...
    return (
        <div>
            <div>
                ...
                <div className="rts-grocery-feature-area rts-section-gapBottom rts-section-gapTop">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="title-area-between">
                                    <h2 className="title-left">Vacuum Sealer Rolls</h2>
